    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WashStationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    AcceptCreditCard = table.Column<bool>(type: "bit", nullable: false),
                    AcceptCash = table.Column<bool>(type: "bit", nullable: false),
                    AcceptMobilePayment = table.Column<bool>(type: "bit", nullable: false),
                    ReservedTimes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Telephone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WashStations", x => x.WashStationId);
                    table.ForeignKey(
                        name: "FK_WashStations_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "AddressId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_WashStations_WashStationId",
                        column: x => x.WashStationId,
                        principalTable: "WashStations",
                        principalColumn: "WashStationId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_WashStationId",
                table: "Offers",
                column: "WashStationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WashStations_AddressId",
                table: "WashStations",
                column: "AddressId");
        }
